...
package com.kelin.archetype.api.cache

import com.kelin.archetype.api.ApiApplication
import com.kelin.archetype.api.cache.DemoService.CACHE_NAME
...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.NONE, classes = [ApiApplication::class])
