 ...
 */
@Configuration
@MapperScan(basePackages = "com.alo7.archetype.persistence.mapper.primary", sqlSessionFactoryRef =
...
public class MybatisPrimarySqlSessionFactoryConfig {
    ...
    public SqlSessionFactory primarySqlSessionFactory() throws Exception {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.alo7.archetype.persistence.entity.primary");
