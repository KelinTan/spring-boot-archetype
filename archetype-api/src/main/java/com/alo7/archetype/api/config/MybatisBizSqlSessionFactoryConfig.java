 ...
 */
@Configuration
@MapperScan(basePackages = "com.alo7.archetype.common.mapper.biz", sqlSessionFactoryRef = "bizSqlSessionFactory")
public class MybatisBizSqlSessionFactoryConfig {
    ...
    public SqlSessionFactory bizSqlSessionFactory() throws Exception {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.alo7.archetype.common.entity.biz");
