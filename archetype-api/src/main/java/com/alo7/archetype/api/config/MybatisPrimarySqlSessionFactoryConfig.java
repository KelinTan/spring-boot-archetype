 ...
 */
@Configuration
@MapperScan(basePackages = "com.alo7.archetype.common.mapper.primary", sqlSessionFactoryRef =
...
public class MybatisPrimarySqlSessionFactoryConfig {
    ...
    public SqlSessionFactory primarySqlSessionFactory() throws Exception {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage("com.alo7.archetype.common.entity.primary");
